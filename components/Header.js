	...
	return (
		<header className="sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md py-5 px-5 md:px-10">
			...
			<div className="flex items-center md:border-2 rounded-full py-2 md:shadow-sm ">
				...
				/>
				<SearchIcon className="hidden md:inline-flex h-8 bg-red-400 p-2 rounded-full text-white cursor-pointer md:mx-2  " />
			</div>
			...
			<div className="flex items-center space-x-4 justify-end text-gray-500">
				...
				<div className="flex border-2 rounded-full items-center p-2">
			...
			{searchInput && (
				<div className="flex flex-col col-span-3 mx-auto">
					...
					/>
					<div className="flex border-b mb-4 items-center text-gray-700">
